...
export function AlertStack({ children }: AlertStackProps) {
  return createPortal(
    <div
      className="pointer-events-none fixed bottom-4 right-[calc(1rem+var(--main-scrollbar-width))] z-[100] flex w-full max-w-sm flex-col-reverse gap-2 md:bottom-8 md:right-[calc(2rem+var(--main-scrollbar-width))]"
      aria-live="polite"
    >
      {children}
    </div>,
